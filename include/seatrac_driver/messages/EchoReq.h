#ifndef _DEF_SEATRAC_DRIVER_MESSAGES_ECHO_REQ_H_
#define _DEF_SEATRAC_DRIVER_MESSAGES_ECHO_REQ_H_
...
struct EchoReq : public Message<EchoReq>
{
    static const CID_E Identifier = CID_ECHO_REQ;
    ACOFIX_T acoFix;
    ...
    EchoReq& operator=(const std::vector<uint8_t>& other)
    {
